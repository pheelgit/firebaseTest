...
export const ShopList = () => {
	const shopItems = useSelector((state) => state.test.posts);
	// return shopItems?.map((card) => (
	// 	<ShopCard key={card.mainId} {...card} />
	// ));
			...
			<section className="mb-32 text-gray-800 text-center md:text-left">
				...
				<div className="flex flex-wrap mb-6">
					...
					<div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
						...
						<p className="text-gray-500">
							...
							vulputate. Ut vulputate est non
							quam dignissim elementum. Donec a
							ullamcorper diam.
						</p>
					</div>
				</div>
				...
				<div className="flex flex-wrap mb-6">
					...
					<div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
						...
						<p className="text-gray-500">
							Suspendisse in volutpat massa.
							Nulla facilisi. Sed aliquet diam
							orci, nec ornare metus semper sed.
							Integer volutpat ornare erat sit
							amet rutrum.
						</p>
					</div>
				</div>
